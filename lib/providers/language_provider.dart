...
class LanguageProvider with ChangeNotifier {
  ...
  Map<String, Object> arabicTexts = {
    ...
    "theme_button_title": "الالوان الافتراضيه ",
    "filters_appBar_title": "الفلاتر",
    "filters_screen_title": "قم بتعديل فلاتر تطبيقك",
    "Gluten-free": "خالي من الجلوتين",
    "Gluten-free-sub": "يتضمن فقط الاطعمة الخالية من الجلوتين",
    ...
    "Affordability.Costly": "مكلفة",
    "Affordability.Luxurious": "باهضة الثمن",
    "recipes_word": "وصفات",
    "toast_message": "تم حفظ الفلاتر",
    "min": "دقيقة",
    "min2": "دقائق",
    ...
    "Steps": "الخطوات",
    "favorites_text":
        "لم تقم بأضافة طعام مفضل حتي الآن \nقم بأضافة بعض الاطعمة..!",
    "ingredients-m1": [
      "4 طماطم",
  ...
  Map<String, Object> englishTexts = {
    ...
    "theme_button_title": "Default Colors",
    ...
    "Affordability.Costly": "Costly",
    "Affordability.Luxurious": "Luxurious",
    "recipes_word": "Recipes",
    "toast_message": "Filters Saved",
    "min": "min",
    "min2": "min",
    ...
    "Steps": "Steps",
    "favorites_text": "You have no favorites yet \n start adding some..!",
    "ingredients-m1": [
      '4 Tomatoes',
